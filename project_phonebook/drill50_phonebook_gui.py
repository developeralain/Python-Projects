...
def load_gui(self):
    ...
    #below are buttons, their associated functions, and their grid placement specifications
...
#below functions create the dB
    drill50_phonebook_func.create_db(self)
    drill50_phonebook_func.onRefresh(self)

    

#below code prevents us from accidentally running this code from this file...we only want to run the code from the main file.
